...
const Features = () => {
    ...
    const data = [
        {
          ...
          description: "Easily find discounted properties at your convenience, anytime and anywhere. Enjoy a hassle-free experience free from daily spam calls, texts, and emails.",
        },
        {
          url: "assets/images/Slide-2.svg",
          title: "Organize Listings with Ease",
          description: "Customize and manage listings from any seller, all within a single, intuitive wishlist.",
        },
        {
          url: "assets/images/Slide-3.svg",
          title: "Collaborate in Real Time",
          description: "Connect and collaborate with verified sellers,peers, and service providers without delays.",
        },
        {
          url: "assets/images/Slide-4.svg",
          title: "Document Management Made Simple",
          description: "Upload, share, and manage documents seamlessly for each property listing.",
        },
        {
          url: "assets/images/Slide-5.svg",
          title: "Streamline Scheduling",
          description: "Create tasks, events, and appointments to ensure every step of your investment process is covered.",
        },
      ];
    ...
    return (
    <div ref={containerRef} className='w-full my-5  feature-section overflow-hidden'>
        <h2 className='text-center text-secondary text-2xl font-black'>
        Features
        </h2>
        <div className='overflow-hidden'><h1 className='headline-text whitespace-nowrap overflow-hidden text-ellipsis text-6xl text-[#ECECEC] font-extrabold leading-tight inline-block '>
     ...
     <Carousel className="w-full ">
      <CarouselContent >
        ...
        images.map((img, index) => (
          ...
          className={`transition-opacity duration-500 carousel-item ${activeIndex === index ? "opacity-100 " : "opacity-0 absolute"}`}
