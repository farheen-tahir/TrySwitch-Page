...
const CardAbout = ({
  ...
  return (
    <Card
      className={cn(
        "about-card bg-[#f5f5f5] h-[24rem] w-60 mx-auto md:w-72  md:m-0 flex justify-between items-center flex-col",
        className
      )}
    >
      {isFooterContent ? (
        <div className="inner-content contents  flex-col justify-between">
          <CardContent className="card-content overflow-hidden w-full relative flex items-center justify-center h-full py-0 my-0 ">
            {/* <Image
              priority
              width={250}
              height={150}
          ...
          <CardFooter className="text-center flex flex-col text">
            <CardTitle className="card-title w-full text-[19px]">
              {title}
            </CardTitle>
        ...
        <div className="inner-content  flex flex-col justify-between">
          <CardHeader className="card-header text-center text">
            <CardTitle className="card-title text-[19px]">{title}</CardTitle>
            <CardDescription className="card-description text-[16px] px-0 ">
              {desc}
            </CardDescription>
          </CardHeader>
          <CardContent className="card-content flex items-center justify-center h-full py-0 my-0 overflow-hidden">
            <Image
              priority
              width={400}
              height={400}
