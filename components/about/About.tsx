...
//     //         animation.phone.from,
//     //         { ...animation.phone.to, duration: 1, delay: index * 0.5 }
//     //       )
//     //       .fromTo(
//     //         animation.text.class,
//     //         animation.text.from,
//     //         { ...animation.text.to, duration: 2, delay: 0.5 }
//     //       );
//     //   });
...
//           // onLeave: (self) => {
//           //   // Remove the pin spacer when the animation finishes
//           //   if (self.spacer && self.spacer.parentNode) {
//           //     self.spacer.parentNode.removeChild(self.spacer);
//           //   }
//           // },
...
//           // pinSpacing:false,
//           // onLeave: () => {
//           //   // ✅ Remove the pin-spacer after animation completes
//           //   const pinSpacer = aboutContainerRef.current?.parentElement;
//           //   if (pinSpacer?.classList.contains("pin-spacer")) {
//           //     pinSpacer.replaceWith(aboutContainerRef.current); // Removes the wrapper
//           //   }
//           // },
//         },
//       });
...
const About: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // if (isSmallScreen) {
    // Small Screen: Animate each card separately.
    const cards = gsap.utils.toArray<HTMLElement>(".card");
    cards.forEach((card, index) => {
      const tl = gsap.timeline({
        scrollTrigger: {
    ...
    // }
    // else if (aboutContainerRef.current) {
    //   // Large Screen: Create one timeline for the cards (pinned)
    //   const cardTimeline = gsap.timeline({
    //     scrollTrigger: {
    //       trigger: aboutContainerRef.current,
    //       start: "top 0%",
    ...
    //       toggleActions: "play none none none",
    //       once: true,
    //       markers: true, // Remove or comment out in production
    //       // Remove the pin spacer once the animation leaves
    //       onLeave: (self) => {
    //         if (self.spacer && self.spacer.parentNode) {
    //           self.spacer.parentNode.removeChild(self.spacer);
    //         }
    ...
    //   cardTimeline
    //     .fromTo(".card-1", { x: -200, opacity: 0 }, { x: 0, opacity: 1, duration: 0.5 })
    //     .fromTo(".card-2", { x: -200, opacity: 0 }, { x: 0, opacity: 1, duration: 0.5 })
    //     .fromTo(".card-3", { x: -200, opacity: 0 }, { x: 0, opacity: 1, duration: 0.5 })
    //     .add(() => {
    //       if (!innerContentTriggered) {
    //         innerContentTimeline.play();
    //         innerContentTriggered = true;
    ...
    //   // Create a separate timeline for inner content (paused until triggered)
    //   const innerContentTimeline = gsap.timeline({ paused: true });
    //   innerContentTimeline
    //     .fromTo(".card-1 .phone", { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 0.25 })
    //     .fromTo(".card-1 .text", { opacity: 0 }, { opacity: 1, duration: 0.25 }, "+=0.2")
    //     .fromTo(".card-2 .phone", { y: -50, opacity: 0 }, { y: 0, opacity: 1, duration: 0.25 }, "+=0.2")
    //     .fromTo(".card-2 .text", { opacity: 0 }, { opacity: 1, duration: 0.25 }, "+=0.2")
    //     .fromTo(".card-3 .phone", { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 0.25 }, "+=0.2")
    //     .fromTo(".card-3 .text", { opacity: 0 }, { opacity: 1, duration: 0.25 }, "+=0.2");
    // }
